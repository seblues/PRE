...
int main(){
    //init dataBase
    sqlite3 *db;
    char macAddr0[8] = {0x00, 0x01, 0x02, 0x03, 0x04, 0x05, 0x06 , 0x07};
    char netAddr0[2] = {0x00, 0x01};

    char macAddr1[8] = {0x01, 0x01, 0x02, 0x03, 0x04, 0x05, 0x06 , 0x07};
    char netAddr1[2] = {0x01,0x00};
